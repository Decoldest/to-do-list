...
function getTaskData(form) {
  ...
  function formatDate(date){
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isValid)(formattedDate) ? (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(formattedDate, 'eee, MMM wo') :
      'No Due Date';
  }
}
