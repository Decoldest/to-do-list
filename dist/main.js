...
const filterDisplay = (currentProject) => {
  const selection = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter(task => task.project === currentProject);
  (0,_addToDos_js__WEBPACK_IMPORTED_MODULE_1__.updateTaskDisplay)(selection);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   filterDisplay: () => (/* binding */ filterDisplay),
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isThisWeek.mjs");
...
function formatDate(date){
  let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parseISO)(date);
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isValid)(formattedDate) ? (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(formattedDate, 'eee, MMM d') : 'No Due Date';
}
...
const addSingleTask = (newTask) => {
  const temp = (0,_toDos_js__WEBPACK_IMPORTED_MODULE_1__.makeToDo)(
    newTask.title,
    newTask.description,
    newTask.dueDate,
    newTask.priority,
...
const addCompletedButton = (newTask) => addButton('Complete', (e) => {
  ...
  (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.upDateComplete)(newTask);
});

const addDeleteButton = (newTask) => addButton('Delete', (e) => {
  e.currentTarget.parentNode.remove();
  (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.removeTaskFromProjects)(newTask);
});
  ...
  btn.addEventListener('click', () => {
    switch (btn.id) {
      case 'today':
        ...
        currentFilter = (task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.isToday)(task.dueDate);
        break;
      case 'week':
        displayCategory.textContent = 'This Week';
        currentFilter = (task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.isThisWeek)(task.dueDate);
        break;
      case 'all':
    ...
    (0,_addProject_js__WEBPACK_IMPORTED_MODULE_2__.updateCurrentProject)('');
    filterDisplay(currentFilter);
  });
});

const filterDisplay = (currentFilter) => {
  const selection = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter(task => currentFilter(task));
...
/* harmony export */   removeTaskFromProjects: () => (/* binding */ removeTaskFromProjects),
/* harmony export */   upDateComplete: () => (/* binding */ upDateComplete)
/* harmony export */ });
