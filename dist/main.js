...
const getCurrentTaskArray = () => {
  return (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getProjects)()[_addProject_js__WEBPACK_IMPORTED_MODULE_2__.currentProject];
}
...
taskButtons.forEach(btn => {
  btn.addEventListener('click', () => {
    let selection;
    if(btn.id === 'today') {
      selection = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.isToday)(task.dueDate));
    } else if(btn.id === 'week') {
      selection = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getAllTasks)().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.isThisWeek)(task.dueDate));
    } else if(btn.id === 'week') {
      selection = _projects_js__WEBPACK_IMPORTED_MODULE_0__.getAllTasks;
    }
